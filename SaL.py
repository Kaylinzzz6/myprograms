...
while True:
    ...
    if square + roll == 100: #to ensure operator goes first, you could've put brackets around square + roll
        print(f"You are now on square {square+roll}")
        print("Winner!")
        break
    elif square + roll < 100:
        new_position = square + roll
        game_dict = { # is a mapping data structure
            9:34,
            54:19,
            40:64,
            90:48,
        ...
        if new_position in game_dict:
            ...
            square += roll # to disable multiple lines of code, use ctrl + /
        # if new_position == 9:
        #     square = 34
